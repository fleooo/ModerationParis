...
class Coupons
{
    ...
    private ?TypesCoupons $types_coupons = null;
    ...
    public function getTypesCoupons(): ?TypesCoupons
    {
        return $this->types_coupons;
    }

    public function setTypesCoupons(?TypesCoupons $types_coupons): static
    {
        $this->types_coupons = $types_coupons;
